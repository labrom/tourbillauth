...
import 'package:tourbillauth/model.dart' as _i4;
...
class MockUserAccessViewModel extends _i1.Mock
  ...
  @override
  List<_i4.InviteRole> listInvites({String? resource}) => (super.noSuchMethod(
        Invocation.method(
          #listInvites,
          [],
          {#resource: resource},
        ),
        returnValue: <_i4.InviteRole>[],
      ) as List<_i4.InviteRole>);

  @override
  List<_i4.AppUserRole> listUsers({String? resource}) => (super.noSuchMethod(
        Invocation.method(
          #listUsers,
          [],
          {#resource: resource},
        ),
        returnValue: <_i4.AppUserRole>[],
      ) as List<_i4.AppUserRole>);

  @override
  List<_i4.UserRole> listUsersAndInvites({String? resource}) =>
      (super.noSuchMethod(
        Invocation.method(
          #listUsersAndInvites,
          [],
        ...
        returnValue: <_i4.UserRole>[],
      ) as List<_i4.UserRole>);
  ...
  @override
  List<_i4.AppUser> findUsers(String? query) => (super.noSuchMethod(
        Invocation.method(
          #findUsers,
          [query],
        ),
        returnValue: <_i4.AppUser>[],
      ) as List<_i4.AppUser>);
